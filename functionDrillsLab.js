...
// alternative method to iterate over array:
...
function theEliminator(pContestants, pLoser) {
  var indexCount = pContestants.length;
  for(var i = 0;i < indexCount; i++) {
    if(pContestants[i] === pLoser) {
      pContestants.splice(i,1);
      i--;
    }
  }
  return pContestants;
...
// *we decrement the iterator in order to test
// all elements of the array
//is there another way to write this for loop? without modifying the array in place?
...
var totalFrogs = stockUpFrogs(91);
...
function bathroom() {
  ...
  bathtub() // I added this
  function bathtub() {
    let sailorDuck = "nautical";
    console.log(rubberDuck) // I added this
  }
}
function pond() {
  let realDuck = "fluffy";
